        ...
        InkWell(
          ...
          child: Container(
            ...
            child: Align(
              ...
              child: Image.asset(
                model.userList[model.currentProfileIndex].isLiked == true ? AssetRes.icFillFav : AssetRes.icFav,
                width: 37,
...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton(
      {Key? key, required this.onTap, this.size, this.iconColor, required this.icon, required this.iconSize})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        height: size ?? 45,
        width: size ?? 45,
        decoration: BoxDecoration(color: ColorRes.white, borderRadius: BorderRadius.circular(50), boxShadow: [
          BoxShadow(color: ColorRes.black.withOpacity(.15), blurRadius: 9.5, offset: const Offset(0, 4)),
        ]),
        child: Center(
          child: Image.asset(
            icon,
