...
class FirebaseNotificationManager {
  ...
  void unsubscribeToTopic() async {
    ...
    await firebaseMessaging.unsubscribeFromTopic('${AppRes.subscribeTopic}_${Platform.isIOS ? 'ios' : 'android'}');
  }

  void subscribeToTopic() async {
    log('Topic UnSubscribe');
    await firebaseMessaging.subscribeToTopic('${AppRes.subscribeTopic}_${Platform.isIOS ? 'ios' : 'android'}');
  }
}
