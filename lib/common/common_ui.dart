...
class CommonUI {
  static Widget profileImagePlaceHolder(
    ...
    return Container(
      width: heightWidth,
      height: heightWidth,
      decoration: BoxDecoration(color: ColorRes.darkOrange10, borderRadius: BorderRadius.circular(borderRadius ?? 50)),
  ...
  static Widget lottieWidget2() {
    return Lottie.asset(AssetRes.loadingLottie, height: 100, width: 100);
  }
